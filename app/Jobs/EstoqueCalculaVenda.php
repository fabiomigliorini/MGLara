...
class EstoqueCalculaVenda extends Job implements SelfHandling, ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Log::info('EstoqueCalculaVenda', ['codprodutovariacao' => $this->codprodutovariacao, 'codestoquelocal' => $this->codestoquelocal]);
