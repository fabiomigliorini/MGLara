...
?>
    ...
    <div class='form-group' style='position:relative'>
            {!! Form::text('data', $data, ['class'=> 'form-control text-center', 'id'=>'data', 'required'=>'required', $disabled=>$disabled]) !!}
    </div>
    ...
    <div class='form-group' style='position:relative'>
        {!! Form::text('barras', $barras, ['class'=> 'form-control text-right', 'required'=>'required', 'id'=>'barras', $disabled=>$disabled]) !!}
    </div>
