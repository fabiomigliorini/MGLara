...
<hr>
{!! Form::model(Request::session()->get('grupo-produto')['show'], ['method' => 'GET', 'class' => 'form-inline', 'id' => 'sub-grupo-produto-search', 'role' => 'search', 'autocomplete' => 'off'])!!}
    <div class="form-group">
        <input type="text" name="subgrupoproduto" id="subgrupoproduto" placeholder="Sub Grupo" class="form-control">
    </div>
    <div class="form-group">
        {!! Form::select('inativo', ['9' => 'Todos', '1' => 'Ativos', '2' => 'Inativos'], (Request::session()->get('grupo-produto')['show']['inativo'] == '' ? '1' : null), ['class' => 'form-control']) !!}
    </div>      
