...
<ol class="breadcrumb header">
    ...
    <li class='active'>
        <small>
            ...
            <a title='Ativar' href="{{ url('vale-compra-modelo/inativo') }}" data-inativar data-codigo="{{ $model->codvalecompramodelo }}" data-acao="inativar" data-pergunta="Tem certeza que deseja inativar o modelo {{ $model->modelo }}? " data-after-inativar="location.reload()"><span class="glyphicon glyphicon-ban-circle"></span></a>
            @else
            <a title='Inativar' href="{{ url('vale-compra-modelo/inativo') }}" data-inativar data-codigo="{{ $model->codvalecompramodelo }}" data-acao="ativar" data-pergunta="Tem certeza que deseja ativar o modelo {{ $model->modelo }}? " data-after-inativar="location.reload()"><span class="glyphicon glyphicon-ok-sign"></span></a>
            @endif
            &nbsp;
