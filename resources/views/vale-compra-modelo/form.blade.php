<div class='row'>
    <div class='col-md-6'>
        <div class="form-group">
            ...
            <div class="col-sm-10">{!! Form::text('modelo', null, [
                'class' => 'form-control',
                'id' => 'modelo',
                'required' => 'required',
                'maxlength' => 50,
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">{!! Form::number('ano', $ano, [
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">{!! Form::select2Pessoa('codpessoafavorecido', null, [
                'class' => 'form-control',
                'id' => 'codpessoafavorecido',
                'required' => 'required',
            ]) !!}</div>
        </div>
    </div>
    <div class='col-md-6'>
        <div class="form-group">
            ...
            <div class="col-sm-10">{!! Form::textarea('observacoes', null, [
                'class' => 'form-control',
                'id' => 'observacoes',
                'rows' => 6,
                'tabindex' => -1,
...
<div class='row'>
            ...
            <div class="col-sm-5">
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        <button class='btn btn-primary' id='btnAdicionarProdutoBarra' tabindex="-1"><i
    ...
    <div class='col-md-6'>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                {!! Form::select2ProdutoBarra('codprodutobarra_pesquisa', null, [
                    'class' => 'form-control',
                    'id' => 'codprodutobarra_pesquisa',
                ]) !!}
            </div>
        </div>
    </div>
...
<ul class="list-group list-group-condensed list-group-hover list-group-striped" id='divListagemProdutos'>
    ...
    @foreach ($model->ValeCompraModeloProdutoBarras as $vcmpb)
        <li class='list-group-item linha_produto'>
            <div class="row">
                {!! Form::hidden('item_codprodutobarra[]', $vcmpb->codprodutobarra, [
                    'class' => 'form-control item_codprodutobarra',
                ]) !!}
                {!! Form::hidden('item_codvalecompramodeloprodutobarra[]', $vcmpb->codvalecompramodeloprodutobarra, [
                    'class' => 'form-control item_codprodutobarra',
                ]) !!}
                <div class='col-md-6'>
                    <div class='col-md-3'>
                ...
                <div class='col-md-6'>
                    <div class='col-md-4'>
                        <div class="input-group">
                            {!! Form::number('item_quantidade[]', $vcmpb->quantidade, [
                                'class' => 'form-control text-right item_quantidade',
                                'min' => 0.0,
                                'step' => 0.001,
                            ]) !!}
                    ...
                    <div class='col-md-3'>
                        {!! Form::number('item_preco[]', $vcmpb->preco, [
                            'class' => 'form-control text-right item_preco',
                            'min' => 0.0,
                            'step' => 0.01,
                        ]) !!}
                    </div>
                    <div class='col-md-4'>
                        {!! Form::number('item_total[]', $vcmpb->total, [
                            'class' => 'form-control text-right item_total',
                            'min' => 0.0,
                            'step' => 0.01,
                        ]) !!}
                    </div>
    ...
    <li class='list-group-item'>
        <div class="row">
            <div class='col-md-offset-6 col-md-6'>
                ...
                <div class="col-sm-5">{!! Form::number('totalprodutos', null, [
                    'class' => 'form-control text-right',
                    'disabled' => 'disabled',
                    'id' => 'totalprodutos',
                ]) !!}</div>
    ...
    <li class='list-group-item'>
        <div class="row">
            <div class='col-md-offset-6 col-md-6'>
                ...
                <div class="col-sm-5">{!! Form::number('desconto', null, [
                    'class' => 'form-control text-right',
                    'id' => 'desconto',
                    'step' => 0.01,
                    'min' => 0.0,
    ...
    <li class='list-group-item'>
        <div class="row">
            <div class='col-md-offset-6 col-md-6'>
                ...
                <div class="col-sm-5">{!! Form::number('total', null, [
                    'class' => 'form-control text-right',
                    'disabled' => 'disabled',
                    'id' => 'total',
                ]) !!}</div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.item_total').change(function(e) {
                ...
                $(this).closest('.linha_produto').find(".item_preco").first().val(Math.round((total /
                    quant) * 100) / 100);
                calculaTotais();
            });
