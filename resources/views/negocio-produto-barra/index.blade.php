...
{!! Form::model(Request::all(), ['route' => ['produto.show', 'produto'=> $model->codproduto], 'method' => 'GET', 'class' => 'form-inline', 'id' => 'produto-npb-search', 'role' => 'search', 'autocomplete' => 'off'])!!}
    ...
    <div class="form-group">
        {!! Form::select('npb_codfilial', $filiais, null, ['style'=>'width:100px', 'id'=>'npb_codfilial']) !!}
    </div>  
    <div class="form-group">
        {!! Form::select('npb_codnaturezaoperacao', $naturezaop, null, ['style'=>'width:100px', 'id' => 'npb_codnaturezaoperacao']) !!}
    </div>
    <div class="form-group">
...
<div class="list-group list-group-striped list-group-hover" id="npbs">
  @foreach($npbs as $npb)
