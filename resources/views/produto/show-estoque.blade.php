...
?>
    ...
    <div class="col-md-4 text-muted">
        ...
        <div class='pull-right'>
            ...
            @if ($arr['estoquemaximo'] < $arr['fisico']['saldoquantidade']) <b class='text-danger'>
                @endif
                {{ formataNumero($arr['estoquemaximo'], 0) }} <span class='glyphicon glyphicon-arrow-up'></span>
                @if ($arr['estoquemaximo'] < $arr['fisico']['saldoquantidade']) </b>
                    @endif
                    @endif
        </div>
    </div>
...
<div id='div-estoque'>
    <div class="panel-group">
        ...
        <br></br>
        @if($model->conferenciaperiodica == true)
        <div class="panel panel-warning">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-12">
                    Item marcado para conferir periodicamente o estoque!
                    </div>
                </div>
            </div>
        </div>
