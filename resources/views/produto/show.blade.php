        ...
        <li class='active' >
            <small>
                ...
                @if (empty($model->inativo))
                    <a href="{{ url('produto/inativar') }}" data-inativar data-codigo="{{ $model->codproduto }}"
                        data-acao="inativar"
                        data-pergunta="Tem certeza que deseja inativar o produto {{ $model->produto }}? "
                        data-after-inativar="location.reload()"><span class="glyphicon glyphicon-ban-circle"></span></a>
                @else
                    <a href="{{ url('produto/inativar') }}" data-inativar data-codigo="{{ $model->codproduto }}"
                        data-acao="ativar" data-pergunta="Tem certeza que deseja ativar o produto {{ $model->produto }}? "
                        data-after-inativar="location.reload()"><span class="glyphicon glyphicon-ok-sign"></span></a>
                @endif
                &nbsp;
                <a href="{{ url("produto/$model->codproduto") }}" data-excluir
                    data-pergunta="Tem certeza que deseja excluir o produto '{{ $model->produto }}'?"
                    data-after-delete="location.replace(baseUrl + '/produto');"><i
                        class="glyphicon glyphicon-trash"></i></a>
                &nbsp;
                <a href="" id="btnVaiPara"><span class="glyphicon glyphicon-new-window"></span></a>
                &nbsp;
                <a target="_blank"
                    href="https://mgspa.mgpapelaria.com.br/#/estoque-estatistica/{{ $model->codproduto }}"><span
    ...
    <div class="col-md-7">
        <div>
            <ul class="nav nav-tabs" role="tablist" id='tab-produto' style="justify-content: center; display: flex;">
                ...
                <li role="presentation"><a href="#tab-woo" aria-controls="profile" role="tab"
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="tab-variacoes">
                    ...
                    |
                    <a href="<?php echo url("produto/{$model->codproduto}/unifica-barras"); ?>">Unifica Barras <span
                            class="glyphicon glyphicon-resize-small"></span></a>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tab-woo">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tab-negocio">
                    ...
                    <div class='clearfix'>
                        <a class="btn btn-primary pull-right" role="button" data-toggle="collapse"
                            href="#filtro-negocio" aria-expanded="false" aria-controls="filtro-negocio">
                    ...
                    <div class="collapse" id="filtro-negocio">
                        ...
                        <div class='well well-sm'>
                            {!! Form::model(Request::session()->get('produto.show.npb'), [
                                'route' => ['produto.show', 'produto' => $model->codproduto],
                                'class' => 'form-horizontal',
                                'method' => 'GET',
                                'id' => 'produto-negocio-search',
                                'role' => 'search',
                                'autocomplete' => 'off',
                            ]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">{!! Form::date('negocio_lancamento_de', null, [
                                    'class' => 'form-control',
                                    'id' => 'negocio_lancamento_de',
                                    'placeholder' => 'De',
                                ]) !!}</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">{!! Form::date('negocio_lancamento_ate', null, [
                                    'class' => 'form-control',
                                    'id' => 'negocio_lancamento_ate',
                                    'placeholder' => 'Até',
                                ]) !!}</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">{!! Form::select2NaturezaOperacao('negocio_codnaturezaoperacao', null, [
                                    'style' => 'width:100%',
                                    'id' => 'negocio_codnaturezaoperacao',
                                ]) !!}</div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-4 control-label">{!! Form::label('negocio_codprodutovariacao', 'Variação') !!}</div>
                                <div class="col-sm-7">{!! Form::select2ProdutoVariacao('negocio_codprodutovariacao', null, [
                                    'style' => 'width:100%',
                                    'id' => 'negocio_codprodutovariacao',
                                    'codproduto' => 'negocio_codproduto',
                                ]) !!}</div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-4 control-label">{!! Form::label('negocio_codproduto', 'Pessoa') !!}</div>
                                <div class="col-sm-7">{!! Form::select2Pessoa('negocio_codpessoa', null, [
                                    'class' => 'form-control',
                                    'id' => 'negocio_codpessoa',
                                    'style' => 'width:100%',
                                    'placeholder' => 'Pessoa',
                                    'ativo' => 9,
                                ]) !!}</div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tab-notasfiscais">
                    ...
                    <div class='clearfix'>
                        <a class="btn btn-primary pull-right" role="button" data-toggle="collapse"
                            href="#filtro-notasfiscais" aria-expanded="false" aria-controls="filtro-notasfiscais">
                            <span class='glyphicon glyphicon-search'></span>
                        </a>
                    </div>
                    ...
                    <div class="collapse" id="filtro-notasfiscais">
                        <br>
                        <div class='well well-sm'>
                            {!! Form::model(Request::session()->get('produto.show.nfpb'), [
                                'route' => ['produto.show', 'produto' => $model->codproduto],
                                'class' => 'form-horizontal',
                                'method' => 'GET',
                                'id' => 'produto-notasfiscais-search',
                                'role' => 'search',
                                'autocomplete' => 'off',
                            ]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">{!! Form::date('notasfiscais_lancamento_de', null, [
                                    'class' => 'form-control',
                                    'id' => 'notasfiscais_lancamento_de',
                                    'placeholder' => 'De',
                                ]) !!}</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">{!! Form::date('notasfiscais_lancamento_ate', null, [
                                    'class' => 'form-control',
                                    'id' => 'notasfiscais_lancamento_ate',
                                    'placeholder' => 'Até',
                                ]) !!}</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">{!! Form::select2Filial('notasfiscais_codfilial', null, [
                                    'style' => 'width:100%',
                                    'id' => 'notasfiscais_codfilial',
                                ]) !!}</div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-4 control-label">{!! Form::label('notasfiscais_codnaturezaoperacao', 'Natureza de Operação') !!}</div>
                                <div class="col-sm-7">{!! Form::select2NaturezaOperacao('notasfiscais_codnaturezaoperacao', null, [
                                    'style' => 'width:100%',
                                    'id' => 'notasfiscais_codnaturezaoperacao',
                                ]) !!}</div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-4 control-label">{!! Form::label('notasfiscais_codprodutovariacao', 'Variação') !!}</div>
                                <div class="col-sm-7">{!! Form::select2(
                                    'notasfiscais_codprodutovariacao',
                                    ['' => ''] + $model->ProdutoVariacaoS->lists('variacao', 'codprodutovariacao')->all(),
                                    null,
                                    ['style' => 'width:100%', 'id' => 'notasfiscais_codprodutovariacao', 'placeholder' => 'Variaçao'],
                                ) !!}</div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-4 control-label">{!! Form::label('notasfiscais_codproduto', 'Pessoa') !!}</div>
                                <div class="col-sm-7">{!! Form::select2Pessoa('notasfiscais_codpessoa', null, [
                                    'class' => 'form-control',
                                    'id' => 'notasfiscais_codpessoa',
                                    'style' => 'width:100%',
                                    'placeholder' => 'Pessoa',
                                    'ativo' => 9,
                                ]) !!}</div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tab-compras">
                    <div id="div-compras">
                        <b>Aguarde...</b>
                        <img width="20px" src="{{ URL::asset('public/img/carregando.gif') }}">
                    </div>
...
@section('inscript')
    <script type="text/javascript">
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            ...
                            if (data.retorno === true) {
                                var mensagem = '<strong class="text-success">Atualizado(s) ' + data
                                    .atualizados + ' registro(s) no Mercos!</strong>';
                            } else {
                                var mensagem =
                                    '<strong class="text-danger">Falha na exportação para Mercos</strong>';
                            }
                        ...
                        .done(function(data) {
                            ...
                            if (data.retorno === true) {
                                if (data.inativo === null) {
                                    var mensagem =
                                        '<strong class="text-success">Exportado para Mercos com o ID ' + data
                                        .produtoid + '</strong>';
                                } else {
                                    var mensagem = '<strong class="text-danger">O Produto ' + data.produtoid +
                                        ' foi excluído no Mercos! Inativando De/Para de Integração!</strong>';
                                }
                            } else {
                                var mensagem =
                                    '<strong class="text-danger">Falha na exportação para Mercos</strong>';
        ...
        $(document).ready(function() {
            ...
            $('a[href="#tab-compras"]').on('shown.bs.tab', function(e) {
                recarregaDiv('div-compras');
                listagemEstoqueAberta = true;
            });
