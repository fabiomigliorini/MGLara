<div class='col-md-5'>
    <div class="form-group">
        ...
        <div class="col-sm-5">{!! Form::select2TipoProduto('codtipoproduto', null, [
            'required' => true,
            'class' => 'form-control',
            'id' => 'codtipoproduto',
            'style' => 'width:100%',
        ...
        <div class="col-sm-4">{!! Form::select2(
            'abc',
            ['A' => 'A - Contínuo', 'B' => 'B - Alto Giro', 'C' => 'C - Comum', 'D' => 'D - Sazonal'],
            null,
            ['class' => 'form-control', 'id' => 'abc', 'style' => 'width:100%', 'required' => true],
        ) !!}</div>
    </div>

    <div class="form-group">
        {!! Form::label('estoque', 'Estoque', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-9" id="wrapper-estoque">{!! Form::checkbox('estoque', true, null, [
            'id' => 'estoque',
            'data-off-text' => 'Não Controla',
            'data-on-text' => 'Controla',
        ]) !!}</div>
    </div>

    <div class="form-group">
        {!! Form::label('codestoquelocal', 'Depósito', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-5">{!! Form::select2Deposito('codestoquelocal', null, [
            'class' => 'form-control',
            'id' => 'codestoquelocal',
            'style' => 'width:100%',
            'required' => true,
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">{!! Form::checkbox('conferenciaperiodica', true, null, [
            'id' => 'conferenciaperiodica',
            'data-off-text' => 'Normal',
            'data-on-text' => 'Periódica',
        ]) !!}</div>
    </div>

    <div class="form-group">
        {!! Form::label('codmarca', 'Marca', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-5">{!! Form::select2Marca('codmarca', null, [
            'class' => 'form-control',
            'id' => 'codmarca',
            'style' => 'width:100%',
            'required' => true,
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">{!! Form::select2SecaoProduto('codsecaoproduto', null, [
            'required' => true,
            'class' => 'form-control',
            'id' => 'codsecaoproduto',
            'style' => 'width:100%',
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">{!! Form::select2FamiliaProduto('codfamiliaproduto', null, [
            'required' => true,
            'class' => 'form-control',
            'id' => 'codfamiliaproduto',
            'style' => 'width:100%',
            'placeholder' => 'Família',
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">{!! Form::select2GrupoProduto('codgrupoproduto', null, [
            'required' => true,
            'class' => 'form-control',
            'id' => 'codgrupoproduto',
            'style' => 'width:100%',
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">{!! Form::select2SubGrupoProduto('codsubgrupoproduto', null, [
            'required' => true,
            'class' => 'form-control',
            'id' => 'codsubgrupoproduto',
            'style' => 'width:100%',
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">{!! Form::select2Ncm('codncm', null, [
            'required' => true,
            'class' => 'form-control',
            'id' => 'codncm',
            'style' => 'width:100%',
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">{!! Form::select2Tributacao('codtributacao', null, [
            'required' => true,
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">{!! Form::select2Cest('codcest', null, [
            'class' => 'form-control',
            'id' => 'codcest',
            'style' => 'width:100%',
            'placeholder' => 'CEST',
...
<div class='col-md-7'>
    <div class="form-group">
        ...
        <div class="col-sm-9" id="produto-descricao">{!! Form::text('produto', null, [
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9" id="wrapper-importado">{!! Form::checkbox('importado', true, null, [
            'id' => 'importado',
            'data-off-text' => 'Nacional',
            'data-on-text' => 'Importado',
        ]) !!}</div>
    </div>

    <div class="form-group">
        {!! Form::label('codunidademedida', 'Preço', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-2">{!! Form::number('preco', null, [
            'required' => true,
            'step' => 0.01,
        ...
        <div class="col-sm-3">{!! Form::select2UnidadeMedida('codunidademedida', null, [
            'required' => true,
            'class' => 'form-control',
            'campo' => 'unidademedida',
            'id' => 'codunidademedida',
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">{!! Form::number('profundidade', null, [
            'step' => 0.01,
            'class' => 'form-control text-right',
            'id' => 'profundidade',
        ]) !!}</div>
    ...
    <div class="form-group">
        {!! Form::label('titulosite', 'Site', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-9">{!! Form::text('titulosite', null, ['class' => 'form-control', 'id' => 'titulosite', 'rows' => '6']) !!}</div>
    </div>
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-sm-2">{!! Form::select2('abc', ['A', 'B', 'C'], null, [
            'class' => 'form-control',
            'id' => 'abc',
            'style' => 'width:100%',
            'required' => true,
...
@section('inscript')
    <script type="text/javascript" src="{{ URL::asset('public/vendor/bootstrap/typeahead.js/typeahead.bundle.js') }}">
    </script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            @if (!empty($model->codsubgrupoproduto))
                $('#codsecaoproduto').val(
                    {{ $model->SubGrupoProduto->GrupoProduto->FamiliaProduto->SecaoProduto->codsecaoproduto }});
            ...
            function descricaoProdutoTypeahead(codsubgrupoproduto, codproduto) {
                var produtoTypeahead = new Bloodhound({
                    remote: {
                        url: baseUrl + "/produto/descricao?q=%QUERY%&codsubgrupoproduto=" +
                            codsubgrupoproduto + "&codproduto=" + codproduto,
                        wildcard: '%QUERY%',
                    },
